...
<div class="w3-main" style="margin-left:300px;margin-top:43px;">
  ...
  <header class="w3-container" style="padding-top:22px">
    <h5><b><i class="fa fa-dashboard"></i> Withdraw Details</b></h5>
  </header>
  ...
  <div class="w3-panel">
    <div class="w3-row-padding" style="margin:0 -16px">
      <div class="w3">
        ...
        <div class="w3-white">
        	<form method="post" name="withdraw_form" action="action.php">
        		<input type="hidden" name="withdraw_action" value="yes">
	        	<table class="w3-table w3-striped w3-white">
		          <tr>
		            <td>Withdraw Amount<br><input type="number" name="withdraw_amount" class="form-control" required></td>
		            <td>Cheque No (Optional)<br><input type="text" id="cheque_no" name="cheque_no" class="form-control"></td>
		            <td>Comment<br><input type="text" name="comment" class="form-control" required></td>
